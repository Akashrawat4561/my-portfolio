...
const achievements = [
  ...
  {
    title: "Winner of SLAB Hackathon",
    description:
      "Built a web automation tool for discovering jobs, internships, and interview opportunities from multiple sources",
    icon: Briefcase,
        ...
        {achievements.map((achievement, index) => (
          ...
          >
            <div className="relative bg-white dark:bg-neutral-800 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-neutral-200 dark:border-neutral-700 h-full">
              <div
                className={`inline-flex p-3 rounded-xl bg-gradient-to-r ${achievement.color} mb-4 group-hover:scale-110 transition-transform duration-200`}
              >
